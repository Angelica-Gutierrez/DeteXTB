            ...
            <div style="color:{text_color};margin-top:0.5rem;">
                <span class="tooltip-wrapper">
                    ...
                    <span class="tooltip-text">
                        Total number of patients registered in the system for TB screening.
                    </span>
                </span>
            </div>
        </div>
        <div style="flex:1;background-color:{dashboard_card_bg};border-radius:12px;padding:1.5rem;text-align:center;">
            ...
            <div style="color:{text_color};margin-top:0.5rem;">
                <span class="tooltip-wrapper">
                    ...
                    <span class="tooltip-icon">?</span>
                    <span class="tooltip-text">
                        Number of patients whose X-ray has been processed by AI but has not yet been confirmed by the doctor.
                    </span>
                </span>
            </div>
        </div>
